...
**Step 2 · 솔루션 설계 & 제안서 초안**
- AI 솔루션 생성: Pain Point 기반 AI 솔루션 자동 설계 (제목, 유형, 설명, 이유, 도구, 공수, 비용)
- 복수 솔루션 선택 + 통합 합성 (JSON 카드 UI — 개요·구성요소·도구·기간/비용·기대효과·구현 순서)
- 예산 / 기간 직접 선택
- 제안서 초안 AI 자동 생성: 6개 항목을 JSON으로 출력 후 컬러 카드 UI로 렌더링
  - 🎯 1. 제안 솔루션 (TO-BE)
  - 📦 2. 구축 범위 (In / Out-of-Scope 2컬럼)
  - 📅 3. 추진 일정 WBS + 마일스톤
  - 👤 4. 추진 조직 (제안사 / 고객사 2컬럼)
  - 💰 5. 사업비 (견적)
  - 💡 6. 기대 효과 + ROI
- 고객 성향 분석 결과를 제안서 작성에 자동 반영 (논리/감정·결론우선/옵션선호·구체/추상)
- 재생성 버튼으로 즉시 재작성, 클립보드 복사

**Step 3 · 실현 가능성**
- 솔루션별 AI 실현 가능성 평가 (강점·리스크·성공 조건·권고)
- 제안서 초안 요약 카드 참조 패널
- 리스크 메모 + 권고 사항 직접 입력
- 반영 항목 선택 후 권고 사항 반영 → 제안서 자동 재생성

**Step 4 · 최종 제안서 확인**
- 제안서 6개 섹션 카드 뷰 (읽기 편의)
- 텍스트 편집 textarea (클립보드 복사 전 수정 가능)
- 전체 복사, STEP 2/3으로 재생성 이동 버튼
- 제안서 완료 체크리스트

**Step 5 · 발표 & 컨펌**
- AI 반론 대응 도우미 (자주 나오는 반론 태그 선택 + 자동 답변 생성)
- 컨펌 체크리스트 + 계약 메모
